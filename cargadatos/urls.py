...
from cargadatos.views import inicioview,estudiante_misestadistivasView,estudiante_vistaejercicios,profesor_estadisticasejerciciosView,profesor_lista_cursoView,profesor_informacion_ejerciciosView,profesor_estadisticas_cursosView,alumnos_sede,lista_tablon
...
urlpatterns = [
    ...
    url('coordinador/alumnossede',alumnos_sede.as_view(), name = 'coordinadoralumnossede'),
