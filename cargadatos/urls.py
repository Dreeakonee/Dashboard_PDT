...
urlpatterns = [
    ...
    url('profesor/estadisticasejercicios/(?P<id_ejercicio>[\w.]+)/',profesor_estadisticasejerciciosView.as_view(), name='profeestadisticasejercicios'),
    ...
    url('profesor/estadisticascursos/(?P<nrc_curso>\d+)',profesor_estadisticas_cursosView.as_view(),name='profeestadisticascursos'),
